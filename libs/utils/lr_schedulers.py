...
class LinearWarmupMultiStepLR(_LRScheduler):
    """
    Sets the learning rate of each parameter group to follow a linear warmup schedule
    between warmup_start_lr and base_lr followed byt co
...
class LinearWarmupNoDecayLR(_LRScheduler):
    """
    Sets the learning rate of each parameter group to follow a linear warmup schedule
    between warmup_start_lr and base_lr followed by a constant lr.
    ...
    def __init__(
        ...
        super(LinearWarmupNoDecayLR, self).__init__(optimizer, last_epoch)
