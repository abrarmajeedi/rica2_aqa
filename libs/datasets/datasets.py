...
def make_data_loader(dataset, is_training, generator, train_batch_size, test_batch_size, num_workers):
    """
        A simple dataloder builder
    """
    loader = torch.utils.data.DataLoader(
        dataset,
        batch_size=train_batch_size if is_training else test_batch_size,
